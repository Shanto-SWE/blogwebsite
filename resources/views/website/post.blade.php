            ...
            <div class="sidebar-box">
              <div class="bio text-center">
                ...
                <div class="bio-body">
                  ...
                  <p class="social">
                    <a href="#" class="p-2"><i class="fab fa-facebook"></i></a>
                    <a href="#" class="p-2"><i class="fab fa-twitter-square"></i></a>
                    <a href="#" class="p-2"><i class="fab fa-instagram-square"></i></a>
                    <a href="#" class="p-2"><i class="fab fa-youtube"></i></a>
                  </p>
                </div>
              </div>
            </div>
...
<script>
    ...
    s.src = 'https://blog-website-4.disqus.com/embed.js';
