      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 site-logo">
            <a href="/" class="text-black h2 mb-0">Blog Website</a>
          </div>
          ...
          <div class="col-8 text-right">
            <nav class="site-navigation" role="navigation">
              ...
              @foreach($categories as $category)
                ...
                @if(Session::has('user'))
                <li><a class="login text-ligh" href="{{route('user.logout')}}">logout</a></li>
               
                @else
                <li><a href="{{route('user.login')}}">Login</a></li>
                
                <li><a class="login text-ligh" href="{{route('user.registerPage')}}">Sign Up</a></li>
                @endif
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          {{ $setting->copyright }} | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" >Colorlib</a>
              <div class="mb-0 mt-2">Developed By Shanto on <a href="https://www.youtube.com/playlist?list=PLl4v4A2HI0YixTm5AsoTu-sKxiQti4-r6">Laravel Blog Development </a></div>
          </div>
        </div>
      </div>
    </div>
